...
I have `8+` years of experience in **React, Angular, Vue.js, TypeScript, Nodejs** and also have `6+` years of experience in **Laravel, ASP.NET, Django, MySQL, Redis**. <br/> And I have also 3+ years of experience in Web3js, solidity, and smart contracts.
